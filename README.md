...
* GNU/Linux host (macOS should be OK too)
* VirtualBox
* Vagrant
...
0. On controller0:
    ...
    ``` 
    vagrant@controller0:~$ sudo /vagrant/installers/mariadb.sh
    vagrant@controller0:~$ sudo /vagrant/installers/keystone.sh
    vagrant@controller0:~$ sudo /vagrant/installers/glance.sh
    vagrant@controller0:~$ sudo /vagrant/installers/placement.sh
...
0. Create networks and upload an image from the controller node:
    ```
